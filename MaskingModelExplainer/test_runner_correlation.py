...
from tests.ADSynteticCorrTest import run_test
from utils.argument_parser import DefaultGeneratedCorr

class GeneratedCorr(DefaultGeneratedCorr):
...
if __name__ == '__main__':
    ...
    path = f'tests/logs/synthetic_Correlation_{time_format(time())}'
    os.mkdir(path)
