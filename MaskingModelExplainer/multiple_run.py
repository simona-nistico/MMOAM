...
from tests.SynteticRuns import run_test
from utils.argument_parser import DefaultGeneratedMultiple

class Generated(DefaultGeneratedMultiple):
...
if __name__ == '__main__':
    ...
    path = f'tests/logs/multi_run_ind_{time_format(time())}'
    os.mkdir(path)
